...
train_parser.add_argument('--gpu', type=int, default=[3,2,1], nargs='+', help='used gpu')
...
test_parser.add_argument('--gpu', type=int, default=[3,2,1], nargs='+', help='used gpu')
...
# embedding begins!
glove_path = '/home/yue/embeddings/glove'
if args.msdialog:
